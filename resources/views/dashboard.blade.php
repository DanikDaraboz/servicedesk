        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-600">{{ __('Closed Tickets') }}</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            {{ __("You have :open open tickets and :in_progress tickets in progress.", [
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-semibold">{{ __('Recent Tickets') }}</h3>
                    ...
                    @if($recentTickets && $recentTickets->count() > 0)
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead>
                                    <tr class="bg-gray-50">
                                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('ID') }}</th>
                                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Subject') }}</th>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-4 text-lg font-medium text-gray-900">{{ __('No tickets yet') }}</h3>
                            <p class="mt-1 text-sm text-gray-500">{{ __('Get started by creating a new support ticket.') }}</p>
                            <div class="mt-6">
                                <a href="{{ route('tickets.create') }}" 
                                   class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                    {{ __('Create Ticket') }}
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-blue-50 border border-blue-100 rounded-lg p-6">
                    <h4 class="font-semibold text-blue-800 mb-3">{{ __('Need help?') }}</h4>
                    <p class="text-blue-700 mb-4">{{ __('Create a new support ticket and our team will help you as soon as possible.') }}</p>
                    <a href="{{ route('tickets.create') }}" 
                ...
                <div class="bg-green-50 border border-green-100 rounded-lg p-6">
                    <h4 class="font-semibold text-green-800 mb-3">{{ __('Check all tickets') }}</h4>
                    <p class="text-green-700 mb-4">{{ __('View all your support tickets, track their status and add comments.') }}</p>
